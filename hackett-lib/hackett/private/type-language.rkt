...
(provide (for-syntax type-literal-ids type-literals type
...
(define-simple-macro (define-base-type name:id)
  ...
  (begin
    ...
    (begin-for-syntax
      (define-syntax ~name (make-pattern-like-pattern-expander
                            (quote-syntax ({~literal #%type:con} {~literal name})))))))
